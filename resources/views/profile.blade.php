...
<body class="antialiased bg-gray-100 flex flex-col min-h-screen ">
    <div class="container mx-auto p-8">
        <h1 class="text-2xl font-bold text-left text-indigo-600 mb-4">Hello, draudzin</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <ul>
                <a href="/"><li class="hover:bg-indigo-200 rounded-lg flex items-center ">
                    ...
                    <div class="">
                        <p class="text-lg font-medium text-gray-900">Order #12345</p>
                        <p class="text-sm text-gray-600">Placed on January 1, 2024</p>
                        <p class="text-sm text-gray-600">Status: Shipped</p>
                        <p class="text-sm text-gray-600">Total: $100.00</p>
                ...
                <a href="/"><li class="hover:bg-indigo-200 rounded-lg flex items-center ">
                    ...
                    <div class="">
                        <p class="text-lg font-medium text-gray-900">Order #67842</p>
                        <p class="text-sm text-gray-600">Placed on February 1, 2024</p>
                        <p class="text-sm text-gray-600">Status: Pending</p>
                        <p class="text-sm text-gray-600">Total: $150.00</p>
