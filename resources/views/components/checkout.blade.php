                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="email" id="your_email"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                                placeholder="name@eastsquad.com" required />
                        </div>
                            ...
                            <div class="flex items-center">
                                <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdownDivider"
                                    ...
                                    <span class="inline-flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2 h-4 w-4" fill="none"
                                            viewBox="0 0 200 100">
                                            <!-- First red stripe -->
                        ...
                        <div>
                            <label for="email"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Company email
                            </label>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ms-4 text-sm">
                                    <label for="dhl"
                                        class="font-medium leading-none text-gray-900 dark:text-white"> DPD </label>
                                    <p id="dhl-text"
                ...
                <div class="flow-root">
                    <div class="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <dl class="flex items-center justify-between gap-4 py-3">
                            ...
                            <dd class="text-base font-medium text-gray-900 dark:text-white">${{ $cart['tax'] }}</dd>
                        </dl>

                        <dl class="flex items-center justify-between gap-4 py-3">
                            <dt class="text-base font-bold text-gray-900 dark:text-white">Total</dt>
                            <dd class="text-base font-bold text-gray-900 dark:text-white">${{ $cart['total'] }}</dd>
                        </dl>
                    </div>
                </div>
