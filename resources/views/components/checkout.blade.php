                ...
                <div class="min-w-0 flex-1 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="f_name" class="mb-2 block text-sm font-medium text-gray-900">First
                                    name*</label>
                            ...
                            <div>
                                <label for="m_name" class="mb-2 block text-sm font-medium text-gray-900 ">Middle
                                    name</label>
                            ...
                            <div>
                                <label for="l_name" class="mb-2 block text-sm font-medium text-gray-900 ">Last
                                    name*</label>
                            ...
                            <div>
                                <label for="addr_line_1" class="mb-2 block text-sm font-medium text-gray-900 ">Address
                                    Line
                                    1*</label>
                            ...
                            <div>
                                <label for="addr_line_2" class="mb-2 block text-sm font-medium text-gray-900 ">Address
                                    Line
                                    2</label>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="tel" id="phone-input" name="phone"
                                            ...
                                            placeholder="29227648" maxlength="11" required
                            ...
                            <div>
                                <label for="vat_number" class="mb-2 block text-sm font-medium text-gray-900 ">VAT
                                    number</label>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4  ">
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="dhl" class="font-medium leading-none text-gray-900 "> DPD
                                        </label>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4  ">
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="express" class="font-medium leading-none text-gray-900 "> Venipak
                                        </label>
