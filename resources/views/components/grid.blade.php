<div class="relative flex min-h-96 flex-col justify-center overflow-hidden bg-gray- py-6 sm:py-12">
  <div class="mx-auto max-w-screen-xl px-4 w-full">
    ...
    <div class="grid w-full sm:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        {{-- element --}}
      <div class="relative flex flex-col shadow-md rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 max-w-sm" id="product" product-id="0">
      ...
      <div class="bg-white py-4 px-3">
       ...
       {{-- product details --}}
<div class="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 z-50 hidden" id="modal">
  <div class="bg-white py-8 mt-10 shadow-lg rounded-xl  hidden" id="productDetail" product-data-id="0">
